...
public class MedianFilter {
    ...
    public static void main(String[] args) {
        try {
            BufferedImage originalImage = ImageIO.read(new File("circuit.png"));
            BufferedImage filteredImage = applyMedianFilter(originalImage, 3); // Adjust the kernel size as needed
            ImageIO.write(filteredImage, "png", new File("output_median.png"));
